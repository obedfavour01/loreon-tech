...
const Group = ({type}:{type:string}) => {
  return (
    <div className={`h-[680px] 
           ...
           ${type == "Devops" ?' bg-bg_blue': 'bg-datagreen'}  rounded-6xl lg:overflow-hidden basis-1/2 `}>
            <Image
                ...
                height={1000}
                alt='devops'
                className=' absolute object-contain w-max h-max block bottom-0 '
            />
    ...
    <div className='w-3/5 text-center'>
        <h1 className='text-6xl text-center font-bold text-white'>Group Session</h1>
        <p className='my-4'>Individualised Training</p>
        <div className='border border-white w-48 mx-auto rounded-5xl p-3'>
            <p className='text-white text-2xl font-bold'>$250

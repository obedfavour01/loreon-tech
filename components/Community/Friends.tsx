...
const Friends = () => {
  return (
    <div className='px-24 xs:max-lg:px-6 mt-[72px] pt-36 pb-24 rounded-t-[60px] bg-[#111111] text-white'>
        ...
        <div className=' flex xs:max-md:flex-col
           flex-wrap justify-items-center gap-12 mt-16 mb-32'>
          <FriendsCard/>
          <FriendsCard/>
          <FriendsCard/>
        </div>
...
const FriendsCard = () => (
  <div className='py-16 px-11 lg:px-6 bg-[#252525] rounded-[60px]  xs:max-lg:min-w-96 w-[calc(33.33%-48px)]'>
